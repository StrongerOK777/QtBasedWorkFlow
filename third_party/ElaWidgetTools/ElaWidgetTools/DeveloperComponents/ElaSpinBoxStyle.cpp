...
void ElaSpinBoxStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex* option, QPainter* painter, const QWidget* widget) const
{
    ...
    case QStyle::CC_SpinBox:
    {
        ...
        painter->drawText(addLineRect, Qt::AlignCenter, _pButtonMode == ElaSpinBoxType::PMSide ? ElaIconChar(ElaIconType::Plus) : ElaIconChar(ElaIconType::AngleUp));
        //减小图标
        painter->drawText(subLineRect, Qt::AlignCenter, _pButtonMode == ElaSpinBoxType::PMSide ? ElaIconChar(ElaIconType::Minus) : ElaIconChar(ElaIconType::AngleDown));
        painter->restore();
        return;
    }
    default:
