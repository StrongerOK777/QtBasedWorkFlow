...
void ElaRollerPickerContainer::paintEvent(QPaintEvent* event)
{
    ...
    else
    {
        ...
        // 确定
        painter.drawText(_overButtonRect, Qt::AlignCenter, ElaIconChar(ElaIconType::Check));
        // 取消
        painter.drawText(_cancelButtonRect, Qt::AlignCenter, ElaIconChar(ElaIconType::Xmark));
    }
    painter.restore();
}
